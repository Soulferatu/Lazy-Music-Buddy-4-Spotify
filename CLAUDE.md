...
- **Track top-up plan (2026-05-18, not executed)**: [Ten_song_fix.md](Ten_song_fix.md) catalogues 78 bands sitting below the 10-track cap (33 at 5, 15 at 6, 13 at 7, 8 at 8, 8 at 9) and lays out a staged retry plan starting with a one-band diagnostic to determine whether the "5-track plateau" comes from offline-resolver under-pagination or from the artist-ID filter discarding compilation hits. Handling guide: [wiki/track_topup_plan.md](wiki/track_topup_plan.md). Blocked on the same shadow ban as the override retry.
